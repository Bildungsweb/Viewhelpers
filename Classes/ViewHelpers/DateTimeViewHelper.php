 ...
 *  Copyright notice
 *
 *  (c) 2012 Christian Hansen <christian@bildungsweb.net>
 *
 *  All rights reserved
 *
...
/**
 *
 * A view helper for encoding german dates and time
 *
 * = Examples =
 *
 * <code title="Normal notation">
 * <bweb:dateTime format="d.M.Y, H:i">{timestamp}</bweb:dateTime>
 * </code>
 * <output>
 * The date and time, for example 14.03.2012, 14:05
 * </output>
 *
 * <code title="Inline notation">
 * {timestamp -> bweb:dateTime(format:'d.M.Y, H:i')}
 * </code>
 * <output>
 * The date and time, for example 14.03.2012, 14:04
 * </output>
 *
 * @package bweb_fe
 * @license http://www.gnu.org/licenses/lgpl.html GNU Lesser General Public License, version 3 or later
 */
class Tx_BwebVh_ViewHelpers_DateTimeViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractViewHelper {
