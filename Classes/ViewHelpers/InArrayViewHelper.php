 ...
 * 
 * Fluid:
 * <bweb:inArray needle="needleString" haystack="{haystackArray}">
 * 
 ...
 */
class Tx_BwebVh_ViewHelpers_InArrayViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractViewHelper {
